        ...
        <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center px-6 py-16">
            ...
            >
                ...
                <h1 className="text-4xl md:text-5xl font-bold text-center mb-6">
                    <span className="text-sky-400 drop-shadow-[0_0_12px_rgba(56,189,248,0.7)]">Cancel &</span>{" "}
                    <span className="text-white">Refund</span>
                </h1>

                {/* Description */}
                <p className="text-lg md:text-xl text-gray-300 mb-10">
                    If you wish to cancel your order or request a refund, please fill out the form below. Our support team will respond within 24-48 hours.
                </p>
                ...
                <form className="mx-auto bg-gray-900 bg-opacity-50 backdrop-blur-md rounded-2xl shadow-[0_0_20px_rgba(56,189,248,0.3)] p-8 space-y-6 text-left border border-gray-700 transition-all hover:border-sky-400/60 max-w-lg">
                    <div>
                        <label className="block text-sky-400 font-medium mb-2">Order ID</label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="block text-sky-400 font-medium mb-2">Reason for Cancellation/Refund</label>
                        <textarea
                            rows={5}
                ...
                <div className="mt-10 text-gray-400 space-y-2 text-center">
                    <p className="flex items-center justify-center gap-2"><Info className="h-5 w-5 text-sky-400" /> Support Team: support@ahm.com</p>
                    <p className="flex items-center justify-center gap-2"><CreditCard className="h-5 w-5 text-sky-400" /> Refunds processed within 5-7 business days</p>
                </div>
            </motion.div>
        </div>
    );
