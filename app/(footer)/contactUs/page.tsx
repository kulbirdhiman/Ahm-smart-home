        ...
        <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center px-6 py-16">
            ...
            >
                ...
                <h1 className="text-4xl md:text-5xl font-bold text-center mb-6">
                    <span className="text-sky-400 drop-shadow-[0_0_12px_rgba(56,189,248,0.7)]">Contact</span>{" "}
                    <span className="text-white">Us</span>
                </h1>

                {/* Description */}
                <p className="text-lg md:text-xl text-gray-300 mb-10">
                    Have a question or want to work with us? Fill out the form below or reach us directly at <span className="text-sky-400 font-semibold">support@ahm.com</span>.
                </p>
                ...
                <div className="mt-10 text-gray-400 space-y-2 text-center">
                    ...
                    <p className="flex items-center justify-center gap-2"><Phone className="h-5 w-5 text-sky-400" /> +91 98765 43210</p>
                    <p className="flex items-center justify-center gap-2"><Mail className="h-5 w-5 text-sky-400" /> support@ahm.com</p>
                </div>
            </motion.div>
        </div>
    );
