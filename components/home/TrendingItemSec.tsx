...
const products = [
  { id: 1, image: "/remote.png", title: "Digital Lock Face", desc: "Smart remote lock with advanced face recognition.", price: "$150", link: "/product/1" },
  { id: 2, image: "/touch.png", title: "Touch Lock Pro", desc: "Fingerprint & touch enabled premium door lock.", price: "$199", link: "/product/2" },
  { id: 3, image: "/3rd.png", title: "3D Face Lock", desc: "3D visual recognition smart door lock system.", price: "$249", link: "/product/3" },
  { id: 4, image: "/3rd.png", title: "Card Theft Lock", desc: "Code card enabled theft-proof lock solution.", price: "$299", link: "/product/4" },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="grid grid-cols-2 gap-8">
          {products.map((prod, index) => (
            <Link key={prod.id} href={prod.link} className="group">
              <motion.div
                onClick={() => setActiveIndex(index)}
                whileHover={{ scale: 1.05, y: -5 }}
                transition={{ type: "spring", stiffness: 300 }}
                className={`relative flex flex-col items-center justify-between bg-black rounded-2xl p-6 shadow-lg max-w-sm mx-auto cursor-pointer ${
        ...
        <div className="relative flex flex-col items-center">
          <AnimatePresence mode="wait">
            <Link href={products[activeIndex].link}>
              <motion.div
                ...
                className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl max-w-md w-full text-center cursor-pointer"
              >
